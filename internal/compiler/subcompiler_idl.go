...
func (self *SubCompilerIDL) CompileFile(ctx context.Context, r exc.Reporter, file idl.File, dumpTokens bool) (*idl.Module, error) {
	lex := NewLexerIDL(r)
...
READLOOP:
	...
	switch syntax {
	case "proto2", "proto3":
		return self.Protobuf.CompileFile(ctx, r, file, dumpTokens)
	case "microglot0", "microglot1":
		return self.Microglot.CompileFile(ctx, r, file, dumpTokens)
	default:
