	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: &astStatementSyntax{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 21, Offset: 20}},
		...
		},
		{
			...
			expected: &astStatementModuleMeta{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 13, Offset: 12}},
		...
		},
		{
			...
			parser: func(p *parserMicroglotTokens) node { return p.parseStatementModuleMeta() },
			expected: &astStatementModuleMeta{
				astNode: astNode{proto.SourceLocation{Line: 3, Column: 9, Offset: 34}},
				uid: astValueLiteralInt{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 13, Offset: 12}},
					token:   *newTokenLineSpan(1, 13, 12, 3, idl.TokenTypeIntegerDecimal, "123"),
					val:     123,
		...
		},
		{
			...
			expected: &astStatementImport{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 17, Offset: 17}},
				uri: astValueLiteralText{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 12, Offset: 11}},
		...
		},
		{
			...
			expected: &astStatementAnnotation{
				astNode:    astNode{proto.SourceLocation{Line: 2, Column: 9, Offset: 47}},
				identifier: *newTokenLineSpan(1, 14, 13, 3, idl.TokenTypeIdentifier, "foo"),
				annotationScopes: []astAnnotationScope{
					astAnnotationScope{
						astNode: astNode{proto.SourceLocation{Line: 1, Column: 19, Offset: 18}},
						scope:   *newTokenLineSpan(1, 19, 18, 3, idl.TokenTypeKeywordAPI, "api"),
					},
					astAnnotationScope{
						astNode: astNode{proto.SourceLocation{Line: 1, Column: 24, Offset: 23}},
						scope:   *newTokenLineSpan(1, 24, 23, 3, idl.TokenTypeKeywordSDK, "sdk"),
					},
				},
				typeSpecifier: astTypeSpecifier{
					astNode:   astNode{proto.SourceLocation{Line: 1, Column: 31, Offset: 30}},
					qualifier: nil,
				...
				uid: &astValueLiteralInt{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 37, Offset: 36}},
		...
		},
		{
			...
			expected: &astStatementConst{
				astNode:    astNode{proto.SourceLocation{Line: 2, Column: 9, Offset: 44}},
				identifier: *newTokenLineSpan(1, 9, 8, 3, idl.TokenTypeIdentifier, "foo"),
				typeSpecifier: astTypeSpecifier{
					astNode:   astNode{proto.SourceLocation{Line: 1, Column: 14, Offset: 13}},
					qualifier: nil,
					typeName: astTypeName{
						astNode:    astNode{proto.SourceLocation{Line: 1, Column: 14, Offset: 13}},
				...
				value: astValue{astValueLiteralInt{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 18, Offset: 17}},
				...
				meta: astMetadata{
					...
					annotationApplication: &astAnnotationApplication{
						astNode: astNode{proto.SourceLocation{Line: 1, Column: 34, Offset: 34}},
						annotationInstances: []astAnnotationInstance{
							astAnnotationInstance{
								astNode:             astNode{proto.SourceLocation{Line: 1, Column: 33, Offset: 33}},
								namespaceIdentifier: nil,
								identifier:          *newTokenLineSpan(1, 30, 29, 3, idl.TokenTypeIdentifier, "baz"),
								value: astValue{astValueLiteralInt{
									astNode: astNode{proto.SourceLocation{Line: 1, Column: 32, Offset: 31}},
		...
		},
		{
			...
			expected: &astStatementEnum{
				astNode:    astNode{proto.SourceLocation{Line: 3, Column: 8, Offset: 31}},
				identifier: *newTokenLineSpan(1, 8, 7, 3, idl.TokenTypeIdentifier, "foo"),
				innerComments: &astCommentBlock{
					astNode: astNode{proto.SourceLocation{Line: 2, Column: 9, Offset: 20}},
					comments: []idl.Token{
				...
				enumerants: []astEnumerant{
					astEnumerant{
						astNode:    astNode{proto.SourceLocation{Line: 3, Column: 3, Offset: 25}},
						identifier: *newTokenLineSpan(3, 3, 25, 3, idl.TokenTypeIdentifier, "bar"),
					},
					astEnumerant{
						astNode:    astNode{proto.SourceLocation{Line: 3, Column: 7, Offset: 29}},
		...
		},
		{
			...
			expected: &astStatementStruct{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 23, Offset: 23}},
				typeName: astTypeName{
					astNode:    astNode{proto.SourceLocation{Line: 1, Column: 10, Offset: 9}},
		...
		},
		{
			...
			expected: &astStatementAPI{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 53, Offset: 53}},
				typeName: astTypeName{
					astNode:    astNode{proto.SourceLocation{Line: 1, Column: 7, Offset: 6}},
				...
				methods: []astAPIMethod{
					astAPIMethod{
						astNode:    astNode{proto.SourceLocation{Line: 1, Column: 51, Offset: 51}},
						identifier: *newTokenLineSpan(1, 29, 28, 3, idl.TokenTypeIdentifier, "baz"),
						methodInput: astAPIMethodInput{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 35, Offset: 35}},
							typeSpecifier: astTypeSpecifier{
								astNode: astNode{proto.SourceLocation{Line: 1, Column: 34, Offset: 33}},
								typeName: astTypeName{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 34, Offset: 33}},
						...
						methodReturns: astAPIMethodReturns{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 51, Offset: 51}},
							typeSpecifier: astTypeSpecifier{
								astNode: astNode{proto.SourceLocation{Line: 1, Column: 50, Offset: 49}},
								typeName: astTypeName{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 50, Offset: 49}},
		...
		},
		{
			...
			expected: &astStatementSDK{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 39, Offset: 39}},
				typeName: astTypeName{
					astNode:    astNode{proto.SourceLocation{Line: 1, Column: 7, Offset: 6}},
					identifier: *newTokenLineSpan(1, 7, 6, 3, idl.TokenTypeIdentifier, "foo"),
				},
				methods: []astSDKMethod{
					astSDKMethod{
						astNode:    astNode{proto.SourceLocation{Line: 1, Column: 37, Offset: 37}},
						identifier: *newTokenLineSpan(1, 13, 12, 3, idl.TokenTypeIdentifier, "baz"),
						methodInput: astSDKMethodInput{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 21, Offset: 21}},
							parameters: []astSDKMethodParameter{
								astSDKMethodParameter{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 20, Offset: 19}},
						...
						methodReturns: &astSDKMethodReturns{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 37, Offset: 37}},
							typeSpecifier: astTypeSpecifier{
								astNode: astNode{proto.SourceLocation{Line: 1, Column: 36, Offset: 35}},
								typeName: astTypeName{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 36, Offset: 35}},
		...
		},
		{
			...
			expected: &astStatementImpl{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 85, Offset: 85}},
				typeName: astTypeName{
					astNode:    astNode{proto.SourceLocation{Line: 1, Column: 8, Offset: 7}},
					identifier: *newTokenLineSpan(1, 8, 7, 3, idl.TokenTypeIdentifier, "foo"),
				},
				as: astImplAs{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 18, Offset: 18}},
					types: []astTypeSpecifier{
						astTypeSpecifier{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 16, Offset: 15}},
							typeName: astTypeName{
								astNode:    astNode{proto.SourceLocation{Line: 1, Column: 16, Offset: 15}},
								identifier: *newTokenLineSpan(1, 16, 15, 3, idl.TokenTypeIdentifier, "bar"),
							},
				...
				requires: &astImplRequires{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 38, Offset: 38}},
				...
				methods: []implmethod{
					astImplSDKMethod{
						...
						methodInput: astSDKMethodInput{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 50, Offset: 50}},
							parameters: []astSDKMethodParameter{
								astSDKMethodParameter{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 49, Offset: 48}},
					...
					astImplAPIMethod{
						astNode:    astNode{proto.SourceLocation{Line: 1, Column: 84, Offset: 84}},
						identifier: *newTokenLineSpan(1, 60, 59, 6, idl.TokenTypeIdentifier, "barney"),
						methodInput: astAPIMethodInput{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 66, Offset: 66}},
							typeSpecifier: astTypeSpecifier{
								astNode: astNode{proto.SourceLocation{Line: 1, Column: 65, Offset: 64}},
								typeName: astTypeName{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 65, Offset: 64}},
						...
						methodReturns: astAPIMethodReturns{
							astNode: astNode{proto.SourceLocation{Line: 1, Column: 81, Offset: 81}},
							typeSpecifier: astTypeSpecifier{
								astNode: astNode{proto.SourceLocation{Line: 1, Column: 80, Offset: 79}},
								typeName: astTypeName{
									astNode:    astNode{proto.SourceLocation{Line: 1, Column: 80, Offset: 79}},
		...
		},
		{
			...
			expected: &astAnnotationInstance{
				astNode:             astNode{proto.SourceLocation{Line: 1, Column: 6, Offset: 6}},
				namespaceIdentifier: nil,
				identifier:          *newTokenLineSpan(1, 3, 2, 3, idl.TokenTypeIdentifier, "foo"),
				value: astValue{astValueLiteralInt{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 5, Offset: 4}},
		...
		},
		{
			...
			parser: func(p *parserMicroglotTokens) node { return p.parseAnnotationInstance() },
			expected: &astAnnotationInstance{
				astNode:             astNode{proto.SourceLocation{Line: 1, Column: 10, Offset: 10}},
				...
				value: astValue{astValueLiteralInt{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 9, Offset: 8}},
		...
		},
		{
			...
			expected: &astValueUnary{
				astNode:  astNode{proto.SourceLocation{Line: 1, Column: 2, Offset: 1}},
		...
		},
		{
			...
			expected: &astValueBinary{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 5, Offset: 5}},
				...
				rightOperand: astValue{astValueIdentifier{
					astNode: astNode{proto.SourceLocation{Line: 1, Column: 4, Offset: 3}},
					components: []idl.Token{
		...
		},
		{
			...
			expected: &astValueLiteralList{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 2, Offset: 2}},
				vals:    []astValue{},
			},
		},
		{
			...
			parser: func(p *parserMicroglotTokens) node { return p.parseValueLiteralList() },
			expected: &astValueLiteralList{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 3, Offset: 3}},
				vals: []astValue{
		...
		},
		{
			...
			parser: func(p *parserMicroglotTokens) node { return p.parseValueLiteralList() },
			expected: &astValueLiteralList{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 4, Offset: 4}},
				vals: []astValue{
					astValue{astValueIdentifier{
						astNode: astNode{proto.SourceLocation{Line: 1, Column: 2, Offset: 1}},
						components: []idl.Token{
		...
		},
		{
			...
			expected: &astValueLiteralStruct{
				astNode: astNode{proto.SourceLocation{Line: 1, Column: 9, Offset: 9}},
				vals: []astLiteralStructPair{
					astLiteralStructPair{
						astNode:    astNode{proto.SourceLocation{Line: 1, Column: 6, Offset: 5}},
